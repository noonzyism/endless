...
netplay_add_packet(session, Packets.SYNC, buffer_u16, buffer_u8, buffer_u16, buffer_u16, buffer_s16, buffer_s16, buffer_bool, buffer_u16, buffer_u16);
netplay_add_packet(session, Packets.JOIN, buffer_string);
netplay_add_packet(session, Packets.ACCEPT, buffer_u16);
