...
while (obj_server.clients[i, 0] != -1) {
	...
	netplay_send(_session, obj_server.clients[i, 2], Packets.SYNC, 0, obj_player.hp, obj_player.x, obj_player.y, obj_player.xspeed, obj_player.yspeed, obj_player.shooting, mouse_x, mouse_y);
	i++;
}